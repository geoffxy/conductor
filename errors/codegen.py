...
def generate_error_class(error_code, error_properties, output_file):
    ...
    output_file.write("\n\n")
    output_file.write(ERROR_CLASS_TEMPLATE.format(
        error_name=name,
        error_code=error_code,
...
def main():
    ...
    with open(args.errors_file) as file:
        raw_errors = yaml.load(file, Loader=yaml.Loader)

    with open(args.output, "w") as file:
        file.write("from .base import ConductorError\n\n")
        file.write("# NOTE: This file was generated by errors/codegen.py. Do not edit\n")
